...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("border-b border-slate-200 p-4 dark:border-slate-800", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("border-t border-slate-200 p-4 dark:border-slate-800", className)}
    {...props}
  />
))
...
>(({ className, isActive, ...props }, ref) => (
  <button
    ref={ref}
    className={cn(
      "w-full rounded-md px-3 py-2 text-sm font-medium text-left transition-colors",
      isActive
